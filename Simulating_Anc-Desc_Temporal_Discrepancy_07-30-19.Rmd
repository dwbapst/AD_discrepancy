...
plot(
  -AD_overlap_uniq, 
  cumProb,
	xlab = "True Overlap Between Anc. & Desc. (Ma)",
...
We can then superimpose 




We can easily superimpose D&A's probability function on this data, ignoring the region of the horizontal axis where the ancestral taxon appeared first
...
A nice smooth curve. Again, note that age offset is plotted so that the pairs with earlier appearing descendants have *positive* offsets, not negative.
