...
Overall, from the last two superimposed plots, we can say that while the two have *extremely* different shapes, possibly having something to do with our relaxation of D&A's strict assumption of descendant and ancestors having similar taxon durations, 
...
One item to note is that discrepancies themselves are not rare in these simulated datasets, as we've already seen.
